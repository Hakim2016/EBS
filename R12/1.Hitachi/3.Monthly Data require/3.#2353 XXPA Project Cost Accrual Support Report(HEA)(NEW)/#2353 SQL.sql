SELECT hou.name,
       ...
       decode(nvl(pol.unit_price * pda.quantity_ordered, 0),
              ...
              gl_currency_api.convert_amount(poh.currency_code,
                                             'SGD',
                                             parameters.p_end_date - 3, --pda.creation_date, -- p_conversion_date,
                                             'Corporate',
                                             pol.unit_price *
...
/*       poh.status_lookup_code,
  ...
  FROM apps.hr_operating_units             hou,
       ...
       --
       (SELECT to_date('2018-04-01 00:00:00', 'yyyy-mm-dd hh24:mi:ss') p_start_date,
               to_date('2018-04-30 23:59:59', 'yyyy-mm-dd hh24:mi:ss') p_end_date,
               --
               /*'10003999'*/
               NULL po_number,
               /*'10003999'*/
